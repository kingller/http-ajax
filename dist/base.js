...
var AjaxBase = /** @class */ (function () {
    ...
    /* eslint-disable @typescript-eslint/indent */
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(options.processData !== false)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.processData(params, { method: method, url: url, options: options, reject: reject })];
                    case 1:
                        params = _a.sent();
                        _a.label = 2;
                    case 2:
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
        ...
        return promise_1.promisify(beforeSendPromise)
            ...
            var processedValue, xhr, chunked, ajaxThis, token, isContentTypeExist, isCacheControlExist, isXCorrelationIDExist, _i, _a, k, v, lowerCaseKey;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getProcessedParams(method, url, params, options, reject)];
                    case 1:
                        processedValue = _b.sent();
                        url = processedValue.url;
                        params = processedValue.params;
                        if (method === Ajax.METHODS.get) {
                            if (params) {
                        ...
                        isContentTypeExist = false;
                        isCacheControlExist = false;
                        isXCorrelationIDExist = false;
                        if (options.headers) {
                            for (_i = 0, _a = Object.keys(options.headers); _i < _a.length; _i++) {
                                k = _a[_i];
                                v = options.headers[k];
    ...
    AjaxBase.prototype.getCacheKey = function (url, params, options) {
        return __awaiter(this, void 0, void 0, function () {
            var method, _options, processedValue;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        method = Ajax.METHODS.get;
                        _options = __assign(__assign({}, options), { cache: true });
                        return [4 /*yield*/, this.getProcessedParams(method, url, params, _options)];
                    case 1:
                        processedValue = _a.sent();
                        url = processedValue.url;
                        params = processedValue.params;
                        return [2 /*return*/, params ? url + "?" + params : url];
                }
            });
        });
    };
    ...
    AjaxBase.prototype.getCache = function (url, params, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getCacheKey(url, params, options)];
                    case 1:
                        key = _a.sent();
                        return [2 /*return*/, this._cache[key]];
                }
            });
        });
    };
